...
The output must be a complete HTML document following this EXACT structure and styling:
...
<head>
    ...
    <style>
        ...
        * {
        ...
        .performance-exceeds,
        strong:contains("Exceeds Expected Results") {
            color: #155724;
            background-color: #d4edda;
        }

        .performance-effective,
        strong:contains("Fully Effective") {
            color: #004085;
            background-color: #cce5ff;
        }

        .performance-developing,
        strong:contains("Developing") {
            color: #856404;
            background-color: #fff3cd;
        }

        .performance-not-meet,
        strong:contains("Does Not Meet Expected Results") {
            color: #721c24;
        ...
        /* Overall Performance Row Styling */
        tr:has(.emoji) {
...
<body>
    <!-- Generate all content sections here following the exact structure from the prompts -->
</body>
</html>

Ensure all sections use the appropriate CSS classes:
- Header info goes in <div class="header-info">
- Great Moment goes in <div class="great-moment">
- Each strategy in Weekly Growth Plan goes in <div class="strategy-box">
- Coaching Notes goes in <div class="coaching-notes">
- Focus areas go in <div class="focus-area">
- Section details go in <div class="section-details">

Use semantic HTML5 elements and ensure all performance levels have appropriate color coding.`
